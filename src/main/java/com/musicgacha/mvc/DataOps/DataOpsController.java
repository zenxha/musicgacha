...
public class DataOpsController {
    ...
    private Player.KeyType animalKey;   //enum radio button
    private boolean cake;
    private Leaders.KeyType cakeKey;
    ...
    public String data(Model model) {
        ...
        Player.setOrder(this.animalKey);
        Leaders.setOrder(this.cakeKey);
        Alphabet.setOrder(this.alphaKey);

        //radio button defaults
        this.animalKey = Player.KeyType.title;
        this.cakeKey = Leaders.KeyType.title;
        ...
        //load circle queue
        this.addCQueue(Player.playerData());
        this.addCQueue(Leaders.cupCakeData());
    ...
    public String dataFilter(
            ...
            @RequestParam(value = "animalKey") Player.KeyType animalKey,
            @RequestParam(value = "cake", required = false) String cake,
            @RequestParam(value = "cakeKey") Leaders.KeyType cakeKey,
            ...
            Model model)
    {
        ...
        if (animal != null) {
            this.addCQueue(Player.playerData());  //adding Animal database to queue
    ...
    public static void main(String[] args)
    {
        ...
        trial.addCQueue(Player.playerData());
        trial.addCQueue(Leaders.cupCakeData());
        ...
        Player.setOrder(Player.KeyType.name);
        Leaders.setOrder(Leaders.KeyType.leader);
        ...
        Player.setOrder(Player.KeyType.title);
        Leaders.setOrder(Leaders.KeyType.title);
